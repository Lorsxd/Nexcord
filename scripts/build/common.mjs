...
export const gitHash = process.env.NEXCORD_HASH || execSync("git rev-parse --short HEAD", { encoding: "utf-8" }).trim();
...
export const gitRemotePlugin = {
    ...
    setup: build => {
        ...
        build.onLoad({ filter, namespace: "git-remote" }, async () => {
            let remote = process.env.NEXCORD_REMOTE;
            if (!remote) {
...
export const commonOpts = {
    ...
    jsx: "transform",
    jsxFactory: "NexcordCreateElement",
    jsxFragment: "NexcordFragment"
};
