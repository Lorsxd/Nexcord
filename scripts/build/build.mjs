...
const sourceMapFooter = s => watch ? "" : `//# sourceMappingURL=nexcord://${s}.js.map`;
...
const buildConfigs = ([
    // Discord Desktop main & renderer & preload
    {
        ...
        footer: { js: "//# sourceURL=file:///NexcordPatcher\n" + sourceMapFooter("patcher") },
        sourcemap,
        plugins: [
    ...
    {
        ...commonOpts,
        entryPoints: ["src/Nexcord.ts"],
        outfile: "dist/renderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///NexcordRenderer\n" + sourceMapFooter("renderer") },
        globalName: "Nexcord",
        sourcemap,
        plugins: [
    ...
    },
    {
        ...
        footer: { js: "//# sourceURL=file:///NexcordPreload\n" + sourceMapFooter("preload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "true",
    ...
    // Nexcord Desktop main & renderer & preload
    {
        ...nodeCommonOpts,
        entryPoints: ["src/main/index.ts"],
        outfile: "dist/nexcordDesktopMain.js",
        footer: { js: "//# sourceURL=file:///NexcordDesktopMain\n" + sourceMapFooter("nexcordDesktopMain") },
        sourcemap,
        plugins: [
            ...nodeCommonOpts.plugins,
            globNativesPlugin
    ...
    },
    {
        ...commonOpts,
        entryPoints: ["src/Nexcord.ts"],
        outfile: "dist/nexcordDesktopRenderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///NexcordDesktopRenderer\n" + sourceMapFooter("nexcordDesktopRenderer") },
        globalName: "Nexcord",
        sourcemap,
        plugins: [
            globPlugins("vesktop"),
    ...
    },
    {
        ...nodeCommonOpts,
        entryPoints: ["src/preload.ts"],
        outfile: "dist/nexcordDesktopPreload.js",
        footer: { js: "//# sourceURL=file:///NexcordPreload\n" + sourceMapFooter("nexcordDesktopPreload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "false",
