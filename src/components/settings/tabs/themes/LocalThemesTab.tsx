...
async function onFileUpload(e: SyntheticEvent<HTMLInputElement>) {
    ...
    const uploads = Array.from(files, file => {
        ...
        return new Promise<void>((resolve, reject) => {
            ...
            reader.onload = () => {
                NexcordNative.themes.uploadTheme(name, reader.result as string)
                    .then(resolve)
                    .catch(reject);
            };
...
export function LocalThemesTab() {
    ...
    async function refreshLocalThemes() {
        const themes = await NexcordNative.themes.getThemesList();
                        ...
                        {IS_WEB ?
                            (
                                ...
                                <QuickAction
                                    ...
                                    action={() => NexcordNative.themes.openFolder()}
                                    Icon={FolderIcon}
                                />
                            )}
                        <QuickAction
                    ...
                    {userThemes?.map(theme => (
                        <ThemeCard
                            ...
                            onDelete={async () => {
                                ...
                                await NexcordNative.themes.deleteTheme(theme.fileName);
                                refreshLocalThemes();
                            }}
                            theme={theme}
                        />
