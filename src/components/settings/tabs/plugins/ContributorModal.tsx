...
import { RenderModalProps, User } from "@nexcord/discord-types";
...
function ContributorModal({ user, modalProps }: { user: User; modalProps: RenderModalProps; }) {
    ...
    const ContributedHyperLink = <Link href="https://nexcord.dev/source">contributed</Link>;
        ...
        <Modal
            ...
            subtitle={
                plugins.length
                    ...
                    : (
                        <Forms.FormText>
                            This person has not made any plugins. They likely {ContributedHyperLink} to Nexcord in other ways!
                        </Forms.FormText>
                    )
            }
        >
