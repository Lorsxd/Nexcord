    ...
    return (
        <section>
            ...
            <Paragraph size="md" className={Margins.bottom20}>
                Nexcord comes with a cloud integration that adds goodies like settings sync across devices.
                It <Link href="https://nexcord.dev/cloud/privacy">respects your privacy</Link>, and
                the <Link href="https://github.com/Nexcord/Backend">source code</Link> is AGPL 3.0 licensed so you
        ...
        <section>
            ...
            <Flex flexDirection="column" gap="1em">
                <FormSwitch
                    ...
                    description="Save your Nexcord settings to the cloud so you can easily keep them the same on all your devices"
