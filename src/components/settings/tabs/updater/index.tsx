...
function VesktopSection() {
    ...
    return (
        <Flex className={Margins.bottom20} flexDirection="column" gap="1em">
            <Card variant="info">
                <HeadingSecondary>Vesktop & Nexcord</HeadingSecondary>
                <Paragraph>Vesktop and Nexcord are two separate things. This updater is for Nexcord.</Paragraph>
    ...
    return (
        <SettingsTab>
            ...
            <FormSwitch
                ...
                description="Automatically update Nexcord without confirmation prompt"
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
            />
            <FormSwitch
                title="Get notified when an automatic update completes"
                description="Show a notification when Nexcord automatically updates"
