...
import { Channel, Message } from "@nexcord/discord-types";
...
function NexcordPopoverButtons(props: { Component: React.ComponentType<MessagePopoverButtonItem>, message: Message; }) {
...
export function _buildPopoverElements(
    ...
    return <NexcordPopoverButtons Component={Component} message={message} />;
}
