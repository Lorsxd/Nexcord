...
import { Channel } from "@nexcord/discord-types";
...
function NexcordChatBarButtons(props: ChatBarProps) {
...
export function _injectButtons(buttons: ReactNode[], props: ChatBarProps) {
    ...
    buttons.unshift(<NexcordChatBarButtons key="nexcord-chat-buttons" {...props} />);
}
...
addContextMenuPatch("textarea-context", (children, args) => {
    ...
    group.splice(idx, 0,
        <Menu.MenuItem id="vc-chat-buttons" key="nexcord-chat-buttons" label="Nexcord Buttons">
            {buttons.map(([id]) => (
