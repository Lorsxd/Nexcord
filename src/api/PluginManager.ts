...
import { FluxEvents } from "@nexcord/discord-types";
...
export function addPatch(newPatch: Omit<Patch, "plugin">, pluginName: string, pluginPath = `Nexcord.Plugins.plugins[${JSON.stringify(pluginName)}]`) {
