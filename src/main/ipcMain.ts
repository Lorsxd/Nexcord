...
const RENDERER_CSS_PATH = join(__dirname, IS_VESKTOP ? "nexcordDesktopRenderer.css" : "renderer.css");
...
ipcMain.handle(IpcEvents.OPEN_MONACO_EDITOR, async () => {
    const title = "Nexcord QuickCSS Editor";
    ...
    const win = new BrowserWindow({
        ...
        webPreferences: {
            preload: join(__dirname, IS_DISCORD_DESKTOP ? "preload.js" : "nexcordDesktopPreload.js"),
