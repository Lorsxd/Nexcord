...
export const CspPolicies: PolicyMap = {
    ...
    "cdn.discordapp.com": ImageAndCssSrc, // Discord CDN, used by Nexcord and some themes to load media
    "media.discordapp.net": ImageSrc, // Discord media CDN, possible alternative to Discord CDN

    // CDNs used for some things by Nexcord.
    ...
    // Function Specific
    "api.github.com": ConnectSrc, // used for updating Nexcord itself
    "ws.audioscrobbler.com": ConnectSrc, // Last.fm API
    "translate-pa.googleapis.com": ConnectSrc, // Google Translate API
    "*.nexcord.dev": ImageSrc, // VenCloud (api.nexcord.dev) and Badges (badges.nexcord.dev)
...
const patchCsp = (headers: PolicyMap) => {
    ...
    if (header) {
        ...
        // we could make unsafe-inline safe by using strict-dynamic with a random nonce on our Nexcord loader script https://content-security-policy.com/strict-dynamic/
        ...
        for (const directive of ["style-src", "connect-src", "img-src", "font-src", "media-src", "worker-src"]) {
            pushDirective(directive, "blob:", "data:", "nexcord:", "vesktop:");
        }
