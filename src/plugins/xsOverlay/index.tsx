...
import type { Channel, Embed, GuildMember, MessageAttachment, User } from "@nexcord/discord-types";
...
async function start() {
    ...
    socket = new WebSocket(`ws://127.0.0.1:${settings.store.webSocketPort ?? 42070}/?client=Nexcord`);
...
const Native = NexcordNative.pluginHelpers.XSOverlay as PluginNative<typeof import("./native")>;
