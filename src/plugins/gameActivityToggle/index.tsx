...
import NexcordToolboxPlugin from "@plugins/nexcordToolbox";
...
const settings = definePluginSettings({
    ...
    location: {
        ...
        options: [
            ...
            { label: "Nexcord Toolbox", value: "TOOLBOX" }
        ],
        get hidden() {
            return !isPluginEnabled(NexcordToolboxPlugin.name);
        }
    }
});
...
function GameActivityToggleButton(props: { nameplate?: any; }) {
    ...
    if (location !== "PANEL" && isPluginEnabled(NexcordToolboxPlugin.name)) return null;
