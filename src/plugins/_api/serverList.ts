    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: "[$1].concat(Nexcord.Api.ServerList.renderAll(Nexcord.Api.ServerList.ServerListRenderPosition.Above))"
            }
        },
        {
            find: ".setGuildsTree(",
            replacement: {
                ...
                replace: "Nexcord.Api.ServerList.renderAll(Nexcord.Api.ServerList.ServerListRenderPosition.In).concat($&)"
            }
        }
    ]
});
