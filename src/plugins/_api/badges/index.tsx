...
const ContributorBadge: ProfileBadge = {
    id: "nexcord_contributor_badge",
    description: "Nexcord Contributor",
...
async function loadBadges(noCache = false) {
    ...
    DonorBadges = await fetch("https://badges.nexcord.dev/badges.json", init)
        .then(r => r.json());
}
            ...
            onClick() {
                openModal(props => (
                    <ErrorBoundary noop onError={() => {
                        props.onClose();
                        NexcordNative.native.openExternal("https://github.com/sponsors/Vendicated");
                    }}>
                        <Modal
                            {...props}
                            title={
                        ...
                        >
                            <div>
                                ...
                                <div style={{ padding: "1em" }}>
                                    <Forms.FormText>
                                        This Badge is a special perk for Nexcord Donors
                                    </Forms.FormText>
                                    <Forms.FormText className={Margins.top20}>
                                        Please consider supporting the development of Nexcord by becoming a donor. It would mean a lot!!
                                    </Forms.FormText>
                                </div>
                            </div>
                            <div>
