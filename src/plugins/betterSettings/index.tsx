...
import { buildPluginMenuEntries, buildThemeMenuEntries } from "@plugins/nexcordToolbox/menu";
...
export default definePlugin({
    ...
    patches: [
            ...
            replacement: [
                {
                    ...
                    replace: "var $1=$self.Layer;class NexcordPatchedOldFadeLayer",
        ...
        { // Load menu TOC eagerly
            ...
            replacement: {
                ...
                replace: "_nexcordBetterSettingsEagerLoad=(async ()=>$1)();"
            },
            predicate: () => settings.store.eagerLoad
        },
    ...
    Layer(props: LayerProps) {
        try {
            [FocusLock.$$nexcordGetWrappedComponent(), ComponentDispatch, Classes.layer].forEach(e => e.test);
        } catch {
    ...
    transformSettingsEntries(list) {
        ...
        for (const item of list) {
            ...
            if (key === "nexcord_plugins" || key === "nexcord_themes") {
                const children = key === "nexcord_plugins"
