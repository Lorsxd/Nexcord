...
export default definePlugin({
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                // react.jsx(WrapperComponent, { NexcordOriginal: AccountPanel, ...
                replace: "$self.PanelWrapper,{NexcordOriginal:$1,"
            }
        },
        {
            find: ".PLAYER_DEVICES",
    ...
    PanelWrapper({ NexcordOriginal, ...props }) {
        return (
            <>
                <ErrorBoundary
                    fallback={() => (
