...
import type { Channel, Role } from "@nexcord/discord-types";
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (m, channel, permCheck) => `${m}!Nexcord.Webpack.Common.PermissionStore.can(${CONNECT}n,${channel})?${permCheck}CONNECT):`
                },
                {
