...
import * as t from "@nexcord/discord-types";
...
export const Forms = {
    ...
    /** @deprecated use Heading from Nexcord */
    FormTitle: Heading,
    /** @deprecated use Paragraph from Nexcord */
    FormText: Paragraph,
...
/** @deprecated use Paragraph, Span, or BaseText from Nexcord */
export const Text = TextCompat;
/** @deprecated use Button from Nexcord */
export const Button = ButtonCompat;
/** @deprecated Use FormSwitch from Nexcord */
...
/** @deprecated import from @nexcord/components */
