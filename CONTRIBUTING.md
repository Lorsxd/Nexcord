...
Nexcord is a community project and welcomes any kind of contribution from anyone!

We have development documentation for new contributors, which can be found at <https://docs.nexcord.dev>.
...
## Improve Nexcord itself

If you have any ideas on how to improve Nexcord itself, or want to propose a new plugin API, feel free to open a feature request so we can discuss.

Or if you notice any bugs or typos, feel free to fix them!

## Contribute to our Documentation

The source code of our documentation is available at <https://github.com/Nexcord/Docs>
...
We have an open support channel in our [Discord community](https://nexcord.dev/discord).
